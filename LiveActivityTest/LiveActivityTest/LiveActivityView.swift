...
struct LiveActivityView: View {
    ...
    let alarmDeadline: Double = 1 // LiveTimeWidget의 progressTotal과 동일하게 설정
...
#Preview {
    LiveActivityView(alarmTime: .constant(LiveActivityView.dateFormatter.date(from: "\(Date.now.formatted(date: .numeric, time: .omitted))_15:53:10")!))
}
